...
public class JSQLService implements IJSQLService {
    ...
    public JSQLService(EntityManager entityManager, String apiKey, String memberKey) {

        this.setHibernateExecutor(JSQLHibernateExecutor.getInstance(entityManager));
